...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    const programId = new solanaWeb3.PublicKey("8GeDy4btKEUvqyLAoqUzTHBfdAV3sn1dE7MDYPvjuhVn");
    const tokenMint = new solanaWeb3.PublicKey("GRjLQ8KXegtxjo5P2C2Gq71kEdEk3mLVCMx4AARUpump");
    let userWallet = null;
    let program = null;
    ...
    function createSetComputeUnitPriceInstruction(microLamports) {
        ...
        return new solanaWeb3.TransactionInstruction({
            programId: solanaWeb3.ComputeBudgetProgram.programId,
            keys: [],
    ...
    async function ensureTokenAccountExists(userWallet, tokenMint, connection) {
        const userTokenAccount = await splToken.getAssociatedTokenAddress(tokenMint, userWallet);
    ...
    async function depositCoins() {
        ...
        try {
            ...
            const [gameVaultPDA] = await solanaWeb3.PublicKey.findProgramAddress(
    ...
    async function spinGameOnChain() {
        ...
        try {
            ...
            await updateBalance();
            spinGame(winnings); // game.js'den gelen fonksiyon
